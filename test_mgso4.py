...
df = pd.read_csv('mgso4_all_1.csv')
#df = pd.read_csv('pore_na2so4.csv')
df.head()

# Putting feature variable to X
X = df.drop('MgSO4',axis=1)
...
##66 116
#
X_train_all, X_test, y_train_all, y_test = train_test_split(X, y, train_size=0.8, random_state=31)#nacl_117,na2so4_57,71,mgso4_31,mgcl2_141
X_train_all.shape, X_test.shape
X_train, X_ver, y_train, y_ver = train_test_split(X_train_all, y_train_all, train_size=0.8, random_state=169)#nacl_45,na2so4_193,33,mgso4_169,mgcl2_45
X_train.shape, y_ver.shape
model = xgb.XGBRegressor(n_estimators=180, 
