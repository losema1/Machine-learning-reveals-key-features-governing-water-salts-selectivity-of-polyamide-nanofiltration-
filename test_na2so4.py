...
##66 116
#
X_train_all, X_test, y_train_all, y_test = train_test_split(X, y, train_size=0.8, random_state=71)#nacl_117,na2so4_57,71,mgso4_31,mgcl2_141
X_train_all.shape, X_test.shape
X_train, X_ver, y_train, y_ver = train_test_split(X_train_all, y_train_all, train_size=0.8, random_state=33)#nacl_45,na2so4_193,33,mgso4_169,mgcl2_45
X_train.shape, y_ver.shape
model = xgb.XGBRegressor(n_estimators=180, 
                         learning_rate=0.05,#0nacl_0.07,na2so4_0.05,0.05,mgso4_0.06,mgcl2_0.05
                         max_depth=7, #nacl_5,na2so4_7,7,mgso4_5,mgcl2_5
                         silent=True, 
                         objective='reg:squarederror',
                         random_state=7,
                         gamma=0,
