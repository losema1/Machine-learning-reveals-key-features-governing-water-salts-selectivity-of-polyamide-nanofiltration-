...
##66 116
#
X_train_all, X_test, y_train_all, y_test = train_test_split(X, y, train_size=0.8, random_state=117)#nacl_117,na2so4_57,71,mgso4_31,mgcl2_141
X_train_all.shape, X_test.shape
X_train, X_ver, y_train, y_ver = train_test_split(X_train_all, y_train_all, train_size=0.8, random_state=100)#nacl_45,na2so4_193,33,mgso4_169,mgcl2_45
X_train.shape, y_ver.shape
model = xgb.XGBRegressor(n_estimators=180, 
                         learning_rate=0.07,#0nacl_0.07,na2so4_0.05,0.05,mgso4_0.06,mgcl2_0.05
