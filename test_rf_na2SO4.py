...
df = pd.read_csv('pore_na2so4_all.csv')
...
###66 116
###
#X_train_all, X_test, y_train_all, y_test = train_test_split(X, y, train_size=0.8, random_state=166)#nacl_117,na2so4_57,71,mgso4_31,mgcl2_141
#X_train_all.shape, X_test.shape
#X_train, X_ver, y_train, y_ver = train_test_split(X_train_all, y_train_all, train_size=0.8, random_state=150)#nacl_45,na2so4_193,33,mgso4_169,mgcl2_45
#X_train.shape, y_ver.shape
#train_X_column_name=list(X_train.columns)
#rfc = RandomForestRegressor(n_estimators=160,                    
#                         max_depth=9,
#                          
#                         random_state=7)
#rfc.fit(X_train, y_train)
...
#=========================================================================================
    ...
    rfc1 = RandomForestRegressor(n_estimators=160,                    
                         max_depth=9,
